#!/bin/bash
# $Id: 4ec296ef95473bccfd4929da6e30bfda72ee7294 $
...
append_zfs() {
	...
	# APPEND KEY FILES, partitions and pass phrases are inherently correct if configured thus
	# copy all zpool keys... assume all partitions are setup correctly ... prompts are not applicable
...
function zfs_keys() {
	...
	#GENKERNEL MUTES THIS
	#offset=$1

	#batch mutes this one
	destination=$1
