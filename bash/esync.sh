...
# THIRD ARG only-sync is a trivial argument, the profile inside mirror.sh will not recognize this type of profile, and will throw a null value for release_base_string
echo "############################### [ RELEASES ] ###################################"
